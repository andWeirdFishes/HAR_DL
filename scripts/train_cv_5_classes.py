...
def main():
    ...
    artifacts_path = Path(project_root) / "artifacts" / "results_4s1s_6fcv"
    ...
    _save_confusion_matrix(
        ...
        title="All Folds — Aggregated Confusion Matrix",
    )
    ...
    final_model = CNNLSTM(in_channels=in_channels, num_classes=num_classes).to(device)
